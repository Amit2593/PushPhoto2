...
public class galaFeatureSelectionActivity extends AppCompatActivity {

    private static final int CAMERA_REQUEST_CODE_GALA = 1;
    private static final String DEBUG = "galaFeatSel";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gala_feature_selection);
        openBackCamera();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CAMERA_REQUEST_CODE_GALA && resultCode == RESULT_OK) {
            ...
            Toast.makeText(galaFeatureSelectionActivity.this, "Gala Sample discarded",
    ...
    public void saveFeatures(View view) {
        ...
        filepath = mStorage.child("Sample Photos").child("Gala").child(imageUri.getLastPathSegment());
        filepath.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                writenewchild(User, "Apple", "Gala", imageUri.getLastPathSegment(), imageDownloadUrl.toString());
